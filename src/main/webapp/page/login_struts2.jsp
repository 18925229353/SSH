...
<div id="regLogin" class="wrap">
	<div class="dialog">
		<div class="box">
			<h4>用户登录</h4>
				<form action="login.action" method="post" id="from">
				...
				<div class="infos">
					<table class="field">					
						...
						<tr>
							...
							<td><input type="text" class="text" name="name" id="name" value="admin"/>

							</td>
						</tr>
						<tr>
							<td class="field">密　　码：</td>
							<td><input type="password" class="text" name="password" id="pwd" value="123456"/>
